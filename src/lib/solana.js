...
export const transferSplToken = async (
  ...
  transaction.add(
    createTransferInstruction(
      fromAta, toAta, walletPublicKey, rawAmount, [], tokenProgramId
    )
  );
